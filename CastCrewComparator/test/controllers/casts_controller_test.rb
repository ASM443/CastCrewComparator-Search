...
class CastsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cast" do
    assert_difference("Cast.count") do
      post casts_url, params: { cast: { first_person: @cast.first_person, second_person: @cast.second_person } }
    end
  ...
  test "should update cast" do
    patch cast_url(@cast), params: { cast: { first_person: @cast.first_person, second_person: @cast.second_person } }
